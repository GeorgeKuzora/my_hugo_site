...
3. **Работа с шаблонами**: Я научился создавать и настраивать шаблоны Django, использовать блоки, включаемые файлы, циклы и условные операторы. Также я освоил использование фильтров и виджетов форм.
4. **Безопасность**: Я научился настраивать аутентификацию и авторизацию в Django, а также использовать CSRF-токены для защиты от атак.
5. **Работа с файлами**: Я научился обрабатывать файлы в Django, настраивать хранение файлов и работу с медиа-библиотекой.
6. **Разработка REST API**: Я научился создавать и настраивать REST API в Django с использованием ViewSets, Routers и Serializers.
7. **Тестирование**: Я научился писать юнит-тесты и интеграционные тесты для Django-приложений, а также использовать Django Test Client для тестирования views.
8. **Оптимизация производительности**: Я научился оптимизировать запросы к базе данных, использовать кэширование на уровне запросов и страниц, а также настраивать и использовать инструменты мониторинга производительности.
9. **Деплоймент и серверы**: Я научился настраивать и использовать различные серверы для Django-приложений, такие как Apache, Nginx, Gunicorn, а также настраивать деплоймент на серверах и в облачных платформах.
10. **Инструменты разработки**: Я научился использовать различные инструменты разработки, такие как виртуальные окружения, Git, Docker, а также настраивать и использовать IDE для разработки на Django.
1. **Создание Docker-образов**: Я научился создавать Docker-образы для своего приложения, включая установку необходимых зависимостей и настройку среды выполнения.
2. **Работа с Dockerfile**: Я научился писать и использовать Dockerfile для создания Docker-образов, включая указание базового образа, установку пакетов, настройку среды и создание томов.
3. **Docker Compose**: Я научился использовать Docker Compose для управления наборами контейнеров, включая создание и управление сложными сетями и связями между контейнерами.
4. **GitHub Actions**: Я научился настраивать и использовать GitHub Actions для автоматизации процессов сборки, тестирования и деплоя. Это включает в себя создание рабочих процессов, использование различных действий и управление зависимостями.
5. **CI/CD**: Я научился настраивать непрерывную интеграцию и доставку (CI/CD) с использованием GitHub Actions, включая автоматизацию сборки, тестирования, деплоя и мониторинга изменений в коде.
6. **Безопасность**: Я научился настраивать безопасность в Docker, включая использование токенов и сертификатов для доступа к частным репозиториям и частным Docker-репозиториям.
7. **Работа с секретами**: Я научился управлять секретными данными в GitHub Actions, используя секреты и переменные окружения для хранения чувствительной информации, такой как пароли и ключи.
8. **Мониторинг и логирование**: Я научился настраивать мониторинг и логирование в Docker и GitHub Actions, включая использование систем мониторинга и логирования для отслеживания состояния и производительности приложения.
9. **Оптимизация производительности**: Я научился оптимизировать производительность Docker-контейнеров, включая использование оптимизированных образов, управление ресурсами и настройку кэширования.
10. **Работа с облачными платформами**: Я научился использовать Docker и GitHub Actions для развертывания приложений на облачных платформах, таких как AWS, Google Cloud и Azure, включая настройку серверов и интеграцию с облачными сервисами.

Это лишь некоторые из основных навыков и знаний, которые я получил в процессе работы над проектом на Django.
